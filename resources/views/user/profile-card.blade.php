...
<div class="pc-profileCard w-screen -mx-96 z-0 -px-96  flex flex-row flex-wrap p-3"> <!-- pc profile card start -->
    <div class="mx-auto w-2/3 ml-96">

  <div class="rounded-lg shadow-lg  bg-blue-600 w-full flex flex-row flex-wrap p-3 antialiased"
   style="
  ...
  "> <!-- background -->
    ...
    <div class="indicator md:w-1/3 w-full">
      ...
      <img class="rounded-lg shadow-lg bg-pink-200 antialiased" src="{{ asset('/storage/'.config('chatify.user_avatar.folder').'/'.$user->avatar) }}">
    </div> <!-- avatar  -->
